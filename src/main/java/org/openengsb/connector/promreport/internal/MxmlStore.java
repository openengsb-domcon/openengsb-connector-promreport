...
public interface MxmlStore {

    void persist(WorkflowLog workflow);
    
    ProcessInstance read(ProcessInstancePointer pipoint);
    
    ProcessInstance read(Long processId, String processInstanceId);
}
